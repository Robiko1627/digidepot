    ...
    <div className="row justify-content-center mt-2 y">
      ...
      <div className="col-md-6 card shadow p-4">
        <form onSubmit={submit}>
          ...
          {message}
          {error}
          <h2 className='text-info'>Add Appliance</h2>
          <input type="text" className="form-control" placeholder="Enter the appliance Name" 
          value={product_name} onChange={(e) => setProductName(e.target.value)} />
          <br />
          {/* {product_name} */}
          <textarea placeholder="Enter some Description of the appliance..." className="form-control" value={product_description}
          onChange={(e) => setProductDescription(e.target.value)}></textarea> <br />
          {/* {product_description} */}
          <input type="number" placeholder="Enter the price of the appliance" className="form-control"
